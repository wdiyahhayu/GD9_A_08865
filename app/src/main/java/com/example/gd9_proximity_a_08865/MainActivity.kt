package com.example.gd9_proximity_a_08865
...
class MainActivity : AppCompatActivity() {
    ...
    //on below line we are creating a variable for our text view
    lateinit var sensorStatusTV: TextView

    //on below line we are creating a variable for our proximity sensor
    lateinit var proximitySensor: Sensor

    //on below line we are creating a variable for sensor manager
